...
class BirdingHotspot : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_birding_hotspot)
            ...
            try {
                ...
                if (response.isSuccessful) {
                    ...
                    if (hotspotList != null && hotspotList.isNotEmpty()) {
                        ...
                        runOnUiThread {
                            Toast.makeText(this@BirdingHotspot, "No hotspots found in the area", Toast.LENGTH_SHORT).show()
                        }
                    }
                } else {
                    runOnUiThread {
                        ...
                        Toast.makeText(this@BirdingHotspot, "API Error: $errorBody", Toast.LENGTH_SHORT).show()
                    }
                }
            } catch (e: Exception) {
                runOnUiThread {
                    Log.e("Hotspots", "An error occurred: ${e.message}")
                    Toast.makeText(this@BirdingHotspot, "An error occurred: ${e.message}", Toast.LENGTH_SHORT).show()
                }
            }
        }
    }
